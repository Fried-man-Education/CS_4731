//--------------------------------------------------------------------------------------------------------------------------------------
// THE ORIGINAL JAVA REFERENCE IMPLEMENTATION OF IMPROVED NOISE - COPYRIGHT 2002 KEN PERLIN.
// CAN BE FOUND HERE.... [url]http://mrl.nyu.edu/~perlin/noise/[/url]
// KEN PERLIN'S 2002 SIGGRAPH Paper.... [url]http://mrl.nyu.edu/~perlin/paper445.pdf[/url]
//--------------------------------------------------------------------------------------------------------------------------------------
...
public class ImprovedPerlinNoise
{
   ...
   138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180
    ...
    public float Noise(float x, float y, float z)
    {
        ...
        floory = Mathf.Floor(y);
        floorz = Mathf.Floor(z);
        X = (int)floorx & 255;
        Y = (int)floory & 255;
        Z = (int)floorz & 255;
